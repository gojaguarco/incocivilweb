...
return(
  <section className="w-full min-h-[calc(100svh-60px)] flex justify-center py-8 md:py-20 default-paddings bg-light-dark z-10">
      <div className="w-full flex flex-col gap-6 max-w-screen-md">
        ...
        <h1>{post.title}</h1>
        <Image className="w-full rounded-2xl max-w-screen-xl" src={urlFor(post.image).width(2000).height(1000).format('webp').url()} alt={post.image.alt} width={2000} height={1000}/>
