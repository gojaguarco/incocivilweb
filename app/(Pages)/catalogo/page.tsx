    ...
    <section className="w-full min-h-screen bg-primary flex justify-center default-paddings z-10 py-14 lg:py-20 text-light">
      <div className="w-full flex flex-col max-w-screen-xl gap-10">
        <header className="flex flex-col gap-0.5">
          ...
          <p className="text-sm sm:text-base font-thin tracking-[3px] uppercase">
            Encuentra el material que se ajuste a tu proyecto.
          </p>
        </header>
        <LightCard className="bg-primary-light md:bg-primary-light px-3 md:px-5 py-3 lg:px-10 gap-2">
          <div className="flex justify-between items-center">
            <h4 className="text-slate-200">Filtra por superficie</h4>
            <SelectFilter
