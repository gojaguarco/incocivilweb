...
export default async function Page(props: { params: Promise<QueryParams> }) {
  ...
  return (
    <Modal>
      <article className="bg-light-dark z-10 gap-2 md:gap-10 p-3 sm:p-5 md:p-8 flex flex-col w-full rounded-2xl max-h-[90vh] overflow-y-scroll">
        <div className="flex flex-col lg:flex-row gap-2 md:gap-10">
          <div className="relative">
            <NavButtons backLink={prevId && `/surface-type/${prevId}`} nextLink={nextId && `/surface-type/${nextId}`} />
