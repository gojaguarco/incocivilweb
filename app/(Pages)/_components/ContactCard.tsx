  ...
  return (
    <form className={`${className} flex flex-col gap-2 rounded-xl py-7 px-6 el-shado justify-center el-shadow`}>
      <div>
        ...
        <button className="px-8 py-2 rounded-lg text-sm text-nowrap flex-shrink-0 bg-accent1 text-slate-100 font-light hover:underline underline-offset-2" type="submit">Enviar Mensaje:</button>
        </div>
    </form>
  )
}
