...
const NavButtons = ({ nextLink, backLink }: TProps) => {

  return (
    <>
      {backLink && (
        <Link className="absolute top-1/2 -translate-y-1/2 left-4 bg-light p-2 rounded-full hover:bg-light-dark text-black" href={backLink}>
      ...
      {nextLink && (
        <Link className="absolute top-1/2 -translate-y-1/2 right-4 bg-light p-2 rounded-full hover:bg-light-dark" href={nextLink}>
