import { Html, Body, Text, Heading, Container, Tailwind, Link, Img, Row, Column } from "@react-email/components";
            ...
            {data.selectedSurfaces.map(surface => (
              ...
              >
                ...
                <Column style={{ paddingLeft: '22px' }}>
                  ...
                  <Text style={productTitle}>Codigo Superficie: {surface.code}</Text>
                  <Text style={productDescription}>Formato: {surface.width}x{surface.height}</Text>
                </Column>
                <Column style={productPriceWrapper} align="right">
                  <Text style={productPrice}>Total cotizado: {numberToColombianPriceString(surface.totalSurface)}</Text>
                </Column>
              </Row>
            ))}
          </Container>
